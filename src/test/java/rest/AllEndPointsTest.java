...
public class AllEndPointsTest {
    ...
    public void setUp() {
        ...
        m1 = new Movie("Test2", "Test2", "Test2", 2000);
        m2 = new Movie("Test1", "Hej", "Med", 1995);
        try {
   ...
   /* @Test
    ...
    public void testAllMovies() throws Exception {
        given()
                .contentType("application/json")
                .get("/xxx/getMovieList").then()
                .assertThat()
                .statusCode(HttpStatus.OK_200.getStatusCode())
                .body("size()", is(2)).and().body("title", hasItems("Test1", "Test2"));
    ...
    public void testSpecificYear() throws Exception {
        given()
                .contentType("application/json")
                .get("/xxx/year/2000").then()
                .assertThat()
                .statusCode(HttpStatus.OK_200.getStatusCode())
                .body("year", equalTo(m1.getReleaseYear()));
    }*/
